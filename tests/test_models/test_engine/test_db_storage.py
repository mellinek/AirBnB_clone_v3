...
class TestDBStorageDocs(unittest.TestCase):
    """Tests to check the document and style of DBStorage class"""
    @classmethod
    def setUpClass(cls):
        """Set up for the document tests"""
...
test_db_storage.py'])
    ...
    def test_db_storage_module_docstring(self):
        """Tests the db_storage.py module docstring"""
...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        """Tests get returns specific object, or none"""
    ...
    @unittest.skipIf(os.getenv('HBNB_TYPE_STORAGE') != 'db',
                     "not testing db storage")
    def test_count(self):
        """tests new adds an object to the database"""
