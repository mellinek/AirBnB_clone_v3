...
class TestReviewDocs(unittest.TestCase):
    """Testing to check the documentation and style of Review class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_test_review(self):
        """Teststhat tests/test_models/test_review.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
    ...
    def test_review_module_docstring(self):
        """Testing  for the review.py module docstring"""
