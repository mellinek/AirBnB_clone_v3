...
class TestAmenityDocs(unittest.TestCase):
    """checks the documentation and style of Amenity class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_amenity_func_docstrings(self):
        """Testing for the presence of docstrings in Amenity methods"""
...
class TestAmenity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """A test that Amenity has attribute name, and it's as an empty string"""
        amenity = Amenity()
    ...
    def test_name_attr_db(self):
        """A test for DBStorage name attribute"""
        amenity = Amenity()
        self.assertTrue(hasattr(Amenity, "name"))
    ...
    def test_to_dict_values(self):
        """testing values in dict returned from to_dict are correct"""
    ...
    def test_str(self):
        """testing the str method has the correct output"""
        amenity = Amenity()
