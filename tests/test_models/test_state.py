...
class TestStateDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_test_state(self):
        """Testing tests/test_models/test_state.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
    ...
    def test_state_module_docstring(self):
        """Testing for the state.py module docstring"""
    ...
    def test_state_class_docstring(self):
        """Testing for the State class docstring"""
        self.assertIsNot(State.__doc__, None,
...
class TestState(unittest.TestCase):
    ...
    def test_is_subclass(self):
        """Tst that State is a subclass of BaseModel"""
        state = State()
    ...
    def test_name_attr(self):
        """Tst that State has attribute name, and it's as an empty string"""
        state = State()
    ...
    def test_to_dict_creates_dict(self):
        """tst to_dict method creates a dictionary with proper attrs"""
        s = State()
        new_d = s.to_dict()
    ...
    def test_to_dict_values(self):
        """tst values in dict returned from to_dict are correct"""
    ...
    @unittest.skipIf(os.getenv('HBNB_TYPE_STORAGE') == 'db',
                     "Testing DBStorage")
    def test_str(self):
        """testing str method has the correct output"""
        state = State()
