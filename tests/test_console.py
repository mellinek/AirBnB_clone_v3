#!/usr/bin/python3
"""
Contain the class TestConsoleDocs
"""
...
class TestConsoleDocs(unittest.TestCase):
    ...
    def test_console_module_docstring(self):
        """Testing the console.py module docstring"""
    ...
    def test_HBNBCommand_class_docstring(self):
        """Testing the HBNBCommand class docstring"""
...
class TestConsoleCommands(unittest.TestCase):
    """Class that tests functionlity of console commands"""
    @classmethod
    def setUpClass(cls):
        """Creates command console to test with"""
        cls.cmdcon = HBNBCommand()

    def setUp(self):
        """Creates in memory buffer to capture stdout"""
        self.output = io.StringIO()

    def tearDown(self):
        """Closes in memory buffer after test completes"""
        self.output.close()

    @unittest.skipIf(os.getenv('HBNB_TYPE_STORAGE') == 'db',
                     "Testing DBStorage")
    def test_do_create(self):
        """Testing do_create method of console"""
